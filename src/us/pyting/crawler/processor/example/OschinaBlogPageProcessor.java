...
public class OschinaBlogPageProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        List<String> links = page.getHtml().links().regex("http://my\\.oschina\\.net/CainGao/blog/\\d+").all();
    ...
    public static void main(String[] args) {
        Spider.create(new OschinaBlogPageProcessor()).addUrl("http://my.oschina.net/CainGao/blog").run();
    }
}
