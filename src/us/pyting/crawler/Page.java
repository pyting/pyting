...
import us.pyting.crawler.selector.Json;
import us.pyting.crawler.selector.Selectable;
 ...
 * {@link #getResultItems()} get extract results to be used in {@link us.pyting.crawler.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author youlink.yi@gmail.com <br>
 * @see us.pyting.crawler.downloader.Downloader
